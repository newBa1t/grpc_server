...
type RegisterRequest struct {
	...
	Username      string                 `protobuf:"bytes,2,opt,name=username,proto3" json:"username,omitempty"` // Добавляем это поле для username
...
const file_protos_proto_auth_proto_rawDesc = "" +
	"\n" +
	"\x17protos/proto/auth.proto\x12\x04auth\"\x9b\x01\n" +
	...
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponseB\x06Z\x04/genb\x06proto3"
